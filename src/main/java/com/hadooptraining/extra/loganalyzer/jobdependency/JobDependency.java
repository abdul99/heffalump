package com.hadooptraining.extra.loganalyzer.jobdependency;
...
public class JobDependency extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new JobDependency(),
                args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        String intermediatePath = outputPath + "Job1";
        ...
        FileInputFormat.setInputPaths(job2, new Path(intermediatePath+"/part*"));
        ...
        JobControl jobControl = new JobControl("JobDependencyDemo");
