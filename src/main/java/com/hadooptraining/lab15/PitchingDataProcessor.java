...
public class PitchingDataProcessor extends Configured implements Tool {
    ...
    public static class PitchingDataProcessorMap extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            String logEntryPattern = "^(\\S+),(\\d{4}),(\\d+),(\\S+),(\\S+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+).(\\d+),(?:[1-9]\\d*|0)?(?:\\.\\d+)?,(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(\\d*),(\\d*),(\\d*)";
    ...
    public static class PitchingDataProcessorMap extends
        ...
        public void map(Text key, PitchingWritable value, Context context)
            ...
            System.out.println("ID:" + pitchingValue.getPlayerID().toString() + " Year:" + pitchingValue.getYear() + " Runs: " + pitchingValue.getRunsAllowed());
